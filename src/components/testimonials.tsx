...
const Testimonials = () => {
  return (
    <>
        <div className="min-w-screen min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center pt-5">
            <div className="w-full bg-white dark:bg-gray-900 border-t border-b border-gray-600 px-5 py-16 md:py-24 text-gray-800 dark:text-gray-400">
                <div className="w-full max-w-6xl mx-auto">
                    <div className="text-center max-w-xl mx-auto">
                        <h1 className="text-6xl md:text-7xl font-bold mb-5 text-gray-600 dark:text-gray-300">What people <br/>are saying.</h1>
                        <h3 className="text-xl mb-5 font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                        <div className="text-center mb-10">
                            <span className="inline-block w-1 h-1 rounded-full bg-teal-500 ml-1"></span>
                            <span className="inline-block w-3 h-1 rounded-full bg-teal-500 ml-1"></span>
