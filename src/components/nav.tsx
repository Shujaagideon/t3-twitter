              ...
              <li className="row-span-3 grid">
                <NavigationMenu.Link asChild>
                  <a
                    ...
                    h-full w-full select-none flex-col justify-end rounded-[6px] bg-gradient-to-t from-cyan-600 to-blue-400 p-[25px] no-underline outline-none focus:shadow-[0_0_0_2px]"
                    href="/"
                  >
...
const ListItem = React.forwardRef(({ className, children, title, ...props }: {className: any, children: React.ReactNode, title: String}, forwardedRef:any) => (
  <li>
    <NavigationMenu.Link asChild>
      <a
        className={classNames(
          'block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors text-gray-600 hover:bg-slate-300 hover:text-slate-900 focus:bg-slate-200 focus:text-gray-600',
          className
        )}
        {...props}
        ref={forwardedRef}
