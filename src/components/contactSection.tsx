...
const ContactSection = () => {
  return (
    <>
        <section className="relative py-20 md:py-32 overflow-hidden dark:bg-gray-900">
            ...
            <div className="relative container px-4 mx-auto">
                <div className="max-w-2xl mx-auto mb-16 text-center">
                    <span className="inline-block py-1 px-3 mb-4 text-xs font-semibold text-teal-900 bg-teal-50 rounded-full">READY TO SUPPORT</span>
                    <h1 className="font-heading text-5xl xs:text-6xl font-bold text-gray-900 dark:text-gray-200 mb-4">
                ...
                <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10 mb-10 md:mb-0">
                    <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white dark:bg-slate-800 dark:border-gray-700 border rounded-xl shadow-lg border-gray-200 rounded-5xl">
                        <div className="max-w-2xs mx-auto text-center">
                            <img className="block mx-auto mb-3" src="saturn-assets/images/contact/icon-teal-email.svg" alt=""/>
                            <h5 className="text-2xl font-bold text-gray-900 dark:text-gray-300 mb-3">Contact Us</h5>
                            <p className="text-gray-500 mb-3">Contact us to seek help from us, we will help you as soon as possible</p>
                            <span className="block text-sm text-teal-900 mb-8">hello@yourdomain.com</span>
                            <a className="relative group inline-block py-4 px-6 text-white font-semibold bg-teal-900 rounded-full overflow-hidden" href="#">
                ...
                <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10">
                    <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white dark:bg-teal-800 dark:border-gray-700 border rounded-xl shadow-lg border-gray-200 rounded-5xl">
                        <div className="max-w-2xs mx-auto text-center">
                            <img className="block mx-auto mb-3" src="saturn-assets/images/contact/icon-teal-headphones.svg" alt=""/>
                            <h5 className="text-2xl font-bold text-gray-900 dark:text-gray-200 mb-3">Customer Service</h5>
                            <p className="text-gray-500 dark:text-gray-300  mb-3">Contact us to seek help from us, we will help you as soon as possible</p>
                            <span className="block text-sm text-teal-900 dark:text-teal-200 mb-8">+08 128 903427</span>
                            <a className="relative group inline-block py-4 px-6 text-white font-semibold bg-teal-900  rounded-full overflow-hidden" href="#">
                            <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
                            <div className="relative flex items-center justify-center">
