...
import DropdownMenuDemo from "~/components/select"

const Pricing: NextPage = () => {

    const checkIcon = <svg className="w-5 h-5 mx-auto text-teal-600" fill="currentColor" viewBox="0 0 20 20"><path d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" /></svg>
    ...
    const [selectedPlan, setSelectedPlan] = useState<any>(plans[0]?.name)

    return (
        <>
            <Header/>
            <section className="py-14 text-gray-600 dark:bg-gray-900 dark:text-gray-200">
                <div className="">
                    <div className='relative max-w-xl mx-auto space-y-3 px-4 sm:text-center md:px-0'>
                        <h3 className="text-teal-600 font-semibold ">
                            Pricing
                        </h3>
                        <p className='text-gray-800 text-3xl font-semibold sm:text-4xl dark:text-gray-100'>
                    ...
                    <div className="mt-16">
                        <div className="sticky top-0 py-6 border-b dark:border-gray-700 bg-white dark:bg-gray-800">
                                            ...
                                            <li key={idx} className={`space-y-4 w-full ${item.name != selectedPlan ? "hidden lg:block" : ""}`}>
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="relative lg:hidden">
                                                        <svg className="w-5 h-5 text-gray-500 dark:text-gray-200 absolute right-0 inset-y-0 my-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                            <path fillRule="evenodd" d="M10 3a.75.75 0 01.55.24l3.25 3.5a.75.75 0 11-1.1 1.02L10 4.852 7.3 7.76a.75.75 0 01-1.1-1.02l3.25-3.5A.75.75 0 0110 3zm-3.76 9.2a.75.75 0 011.06.04l2.7 2.908 2.7-2.908a.75.75 0 111.1 1.02l-3.25 3.5a.75.75 0 01-1.1 0l-3.25-3.5a.75.75 0 01.04-1.06z" clipRule="evenodd" />
                                                        </svg>
                                                        <DropdownMenuDemo plans={plans} change={setSelectedPlan}/>
                                                    </div>
                                                </div>
                                                <div className='text-gray-800 dark:text-gray-200 text-3xl font-semibold'>
                                                    ${item.price} <span className="text-xl text-gray-600 dark:text-gray-400 font-normal">/mo</span>
                                                </div>
                                                <p className="text-sm">
                                                    {item.desc}
                                                </p>
                        ...
                        <div className="max-w-screen-xl mx-auto mt-10 space-y-4 px-4 overflow-auto md:overflow-visible md:px-8">
                            {
                                tables.map((table, idx) => (
                                    <table key={idx} className="w-full table-auto text-sm text-left">
                                        <thead className="text-gray-600 font-medium border-b dark:border-gray-700">
                                            <tr>
                                                <th className="z-20 top-12 py-6 lg:sticky">
                                                    <div className="flex items-center gap-x-3">
                                                        <div className="w-12 h-12 text-teal-600 rounded-full border flex items-center justify-center">
                                                            {table.label_icon}
                                                        </div>
                                                        <h4 className="text-gray-800 dark:text-gray-400 text-xl font-medium">
                                                            {table.label}
                                                        </h4>
                                                    </div>
                                                </th>
                                        ...
                                        <tbody className="text-gray-600 dark:text-gray-200 divide-y dark:divide-gray-700">
                                            {
